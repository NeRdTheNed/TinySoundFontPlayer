...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=TinySoundFontPlayer Demo Installer\n"
      else:
        line="OutputBaseFilename=TinySoundFontPlayer Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the TinySoundFontPlayer Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the TinySoundFontPlayer installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=TinySoundFontPlayer Demo installer\n"
     else:
       line="SetupWindowTitle=TinySoundFontPlayer installer\n"
