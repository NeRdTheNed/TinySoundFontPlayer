...
NOTARIZE_BUNDLE_ID=com.NeRdTheNed.TinySoundFontPlayer
NOTARIZE_BUNDLE_ID_DEMO=com.NeRdTheNed.TinySoundFontPlayer.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/TinySoundFontPlayer.iss
#  git checkout installer/TinySoundFontPlayer.pkgproj
