...
def main():
  ...
  for dir in dirwalk(outputpath, inputprojectname, outputprojectname, "NeRdTheNed", manufacturer, oldroot, newroot):
    pass

  #replace project name in root
  for dir in dirwalk(scriptpath, inputprojectname, outputprojectname, "NeRdTheNed", manufacturer, oldroot, newroot):
    pass

  #replace project name in github
  for dir in dirwalk(scriptpath + "/.github/workflows", inputprojectname, outputprojectname, "NeRdTheNed", manufacturer, oldroot, newroot):
    pass

  #replace project name in vscode
  for dir in dirwalk(scriptpath + "/.vscode", inputprojectname, outputprojectname, "NeRdTheNed", manufacturer, oldroot, newroot):
    pass
